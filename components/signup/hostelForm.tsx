...
export default function HostelForm({
  ...
  hostelStatus: string;
  setHostelStatus: Function;
  messStatus: string;
  setMessStatus: Function;
  step: number;
  setStep: Function;
}) {
      ...
      <CardContent>
        <form onSubmit={handleLogin}>
          <div className="grid w-full items-center gap-10">
            <div className="flex flex-col gap-4">
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    <SelectItem
                      value="Hostel - On Campus"
                      onChange={(e) => setHostelStatus('Hostel - On Campus')}
                    >
                      Hostel - On Campus
                    </SelectItem>
                    <SelectItem
                      value="Hostel - Off Campus"
            ...
            <div className="flex flex-col gap-4">
              <Label htmlFor="mess" className="text-lg">
                Mess*
              </Label>
              <Select>
                <SelectTrigger className="w-fit">
