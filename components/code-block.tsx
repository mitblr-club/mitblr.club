...
export default function CodeBlock({ code, filename }: Props) {
  ...
  return (
    <div className="max-h-screen w-full bg-gradient-to-r from-violet-200 to-violet-400 p-4 !pr-0 md:p-8 lg:p-12 [&>pre]:rounded-none">
      <div className="h-full overflow-hidden rounded-s-lg">
        ...
        <div className="max-h-full overflow-scroll border-t-2 border-neutral-700 bg-neutral-900 text-sm [&>pre]:!bg-neutral-900 [&>pre]:py-3 [&>pre]:pl-4 [&>pre]:pr-5 [&>pre]:leading-snug [&_code]:block [&_code]:w-fit [&_code]:min-w-full">
