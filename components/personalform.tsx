...
export default function PersonalForm(
    ...
    number:string,setNumber:Function,
    appNo:string,setAppNo:Function,
    regNo:string,setRegNo:Function,
    step:number,setStep:Function}
        ...
        function handleNext(event: any){
            ...
            if((!appNo.startsWith("121")&&!appNo.startsWith("122")&&!appNo.startsWith("123"))||appNo.length !== 9){
            ...
            if((!regNo.startsWith("21")&&!regNo.startsWith("22")&&!regNo.startsWith("23"))||regNo.length !== 9){
        ...
        <form onSubmit={handleNext}>
          <div className="grid w-full items-center gap-4">
            ...
            <div className="flex flex-col space-y-1.5">
              ...
              <Input type="text" id="appNo" placeholder="Your Application Number" 
            ...
            <div className="flex flex-col space-y-1.5">
              ...
              <Input type="text" id="regNo" placeholder="Your Registration Number" 
