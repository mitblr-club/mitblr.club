...
export default function CourseForm(
    ...
    {course:string, setCourse:Function,
    gradYear:string, setGradYear:Function,}
    ){
        ...
        <form onSubmit={handleLogin}>
          <div className="grid w-full items-center gap-10">
            <div className="flex flex-col gap-4">
              <Label htmlFor="course" className="text-lg">Course/Stream*</Label>
                <Select>
            ...
            <div className="flex flex-col gap-4">
              <Label htmlFor="gradYear" className="text-lg">Year of Graduation*</Label>
                <Select>
                    <SelectTrigger className="w-fit">
