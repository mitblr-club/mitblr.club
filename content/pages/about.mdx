...
<div className="mt-6 flex w-full flex-col gap-4 md:inline-flex md:flex-row">
  <img src="/demo-blogs.png" className="w-full rounded-md md:w-[49.5%]" />
  <img src="/demo-events.png" className="w-full rounded-md md:w-[49.5%]" />
</div>
